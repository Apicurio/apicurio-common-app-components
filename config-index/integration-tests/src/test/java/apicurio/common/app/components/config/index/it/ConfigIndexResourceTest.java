...
public class ConfigIndexResourceTest {
    ...
    public void testGetDynamicConfigInfo() {
        ...
        Assertions.assertEquals("apicurio.properties.dynamic.long", allProperties.getProperty("apicurio.properties.dynamic.long").getName());
        Assertions.assertEquals("17", allProperties.getProperty("apicurio.properties.dynamic.long").getValue());
        ...
        ConfigProp booleanProp = given()
                .when().get("/config/all/apicurio.properties.dynamic.bool").as(ConfigProp.class);
        ...
        Assertions.assertEquals("true", acceptedProperties.getPropertyValue("apicurio.properties.dynamic.bool"));
